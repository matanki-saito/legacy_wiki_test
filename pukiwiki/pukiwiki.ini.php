...
define('DATA_DIR',      DATA_HOME . 'testwikidata/wiki/'     ); // Latest wiki texts
define('DIFF_DIR',      DATA_HOME . 'testwikidata/diff/'     ); // Latest diffs
define('BACKUP_DIR',    DATA_HOME . 'testwikidata/backup/'   ); // Backups
define('CACHE_DIR',     DATA_HOME . 'testwikidata/cache/'    ); // Some sort of caches
define('UPLOAD_DIR',    DATA_HOME . 'testwikidata/attach/'   ); // Attached files and logs
define('COUNTER_DIR',   DATA_HOME . 'testwikidata/counter/'  ); // Counter plugin's counts
